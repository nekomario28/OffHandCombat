...
public abstract class ItemInHandRendererMixin {
    ...
    private void offhandcombat$renderIndependentSwing(
        ...
        float resolved = ClientDualSwingProgress.resolve(player, hand, swingProgress, partialTick);
        original.call(renderer, player, partialTick, pitch, hand, resolved, stack, equipProgress,
